...
| `fig3_wavelength_psf_scale.pdf/.png` | Fig 3 — same-mask cross-wavelength PSF scale, all_open_window at 450/550/650 nm, same log scale + cumulative enclosed energy curves | Ch.3 |
