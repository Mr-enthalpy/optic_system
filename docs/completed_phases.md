...
External modelling or reconstruction handoffs should be generated by explicit
conversion or publication steps. The raw capture file should not be overwritten
or treated as training-ready by default. This is historical Phase 2 wording;
the current cross-repository boundary is documented in
